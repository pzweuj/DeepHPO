...
6. **否定语义识别**：注意否定词（非、无、不、未、否认、未见等），否定词修饰的内容表示**不存在**该症状/体征，**严禁匹配**被否定的术语
...
候选术语表（HP:ID|英文名|中文名|中文定义）：
---
HP:0012251|ST segment elevation|ST段抬高|心电图ST段向上偏移
HP:0001658|Myocardial infarction|心肌梗死|心肌缺血性坏死
HP:0032141|Coronary artery disease|冠心病|冠状动脉狭窄或阻塞
HP:0000822|Hypertension|高血压|血压持续升高
---

输入诊断："急性非ST段抬高型心肌梗死"
输出：
[{"hpo_id":"HP:0001658","confidence":"高","remark":"【心肌梗死】→ 诊断明确，'非ST段抬高型'是心肌梗死的一种亚型"},
{"hpo_id":"HP:0032141","confidence":"中","remark":"【冠心病】→ 心肌梗死的病因诊断"}]

（关键说明："非ST段抬高型心肌梗死"≠"ST段抬高"！此诊断含有否定词"非"，表示**不伴有ST段抬高**，因此HP:0012251 ST段抬高**不可匹配**）

## Example 4（否定症状不匹配）
候选术语表（HP:ID|英文名|中文名|中文定义）：
---
HP:0001250|Seizure|癫痫发作|大脑异常放电
HP:0002321|Vertigo|眩晕|旋转感
HP:0001289|Confusion|意识模糊|认知障碍
---

输入症状："眩晕，无癫痫发作"
输出：
[{"hpo_id":"HP:0002321","confidence":"高","remark":"【眩晕】→ 症状精确匹配"}]

（说明：输入中的"无癫痫发作"含有否定词"无"，表示不存在癫痫，因此HP:0001250不可匹配）
