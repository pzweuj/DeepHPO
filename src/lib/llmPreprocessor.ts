...
1. **提取患者本人当前存在的症状**，包括：
   ...
   - 拟诊断的疾病名称
   - **基于医学知识谨慎推断的症状**：
     * 仅推断与诊断/疾病高度相关、几乎必然伴随的核心症状
     * 不要推断非典型、可能不存在或因人而异的症状
     * 例如：诊断"脑梗死"可谨慎推断"肢体无力"（核心症状），但不应推断"失语""偏盲"等非必然症状
...
**重要提示**：
- symptoms数组应包含明确提及的症状和谨慎推断的核心症状
- 推断原则：宁缺毋滥，只推断高度确信的核心症状
...
注：糖尿病症状因人而异，不推断"三多一少"等非必然症状

**示例2**：
输入："发作性认知障碍1天余；患者于1天余前出现认知障碍，表现为记忆力下降、认字困难，伴头晕。既往病史：脑梗死、肝硬化。拟'脑梗死'收入我科。"
输出：
{
  "symptoms": ["发作性认知障碍", "记忆力下降", "认字困难", "头晕", "肢体无力"],
  "medicalHistory": ["脑梗死", "肝硬化"],
  "diagnosis": ["脑梗死"],
  "negatedSymptoms": [],
  "familyHistory": []
}
注：仅推断脑梗死核心症状"肢体无力"，不推断失语、偏盲等非必然症状`,
        messages: [{
          role: 'user',
          content: input
        }],
